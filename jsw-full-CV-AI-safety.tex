...
\textbf{F64}
\begin{itemize*}
    \item Experimenting with healthcare applications of large language models such as Claude and Chat\textsc{gpt}, document \textsc{q\&a}
\end{itemize*}
%\textbf{Loloquent}
%\begin{itemize*}
%	\item Foreign language lessons taught by a lolcat named Lolo
%	\item Short silly stories generated by Chat\textsc{gpt} and a speech synthesizer
%	\item Coding a Swift\textsc{ui} app with Flask backend, working with \textsc{ux} designer
%\end{itemize*}
%
\bigskip
\mhead{Professional \newline Appointments}%
...
\begin{itemize*}
    \item Designed, implemented, and hardware tested custom safety-focused automation system for use in carbon sequestration
...
\emph{\textsc{gn\&c} engineer, 6-\textsc{dof} (full-time contractor)} \rdate{\textsc{jul}~2021--\textsc{jun}~2022}
\begin{itemize*}
   \item Advised organization on diversity, equity, and inclusion as part of \textsc{de\&i} council
   \item Derived, designed, and prototyped automation, navigation system and wrote simulation models for \textsc{xl}-1 lunar lander
   %\item Designed automations for high-level planning of robotic activities
...
%\begin{itemize*}
%   \item Proposed Burning Man honorarium project: When participants interact negatively with these metal sculptures of endangered species, the fire inside them dims and the music changes; when participants play music to the animals, their virtual `health' improves and they sing back to the participants
...
\begin{itemize*}
  ...
  %\item Managed multiple research fellows to deliver engineering designs, business plans, and technical reports 
...
\begin{itemize*}
  %\item Mentored interns and Google Summer of Code students
  ...
  %\item Linear algebra, vector calculus, differential equations, optimization
\end{itemize*}
...
\begin{itemize*}
  \item Assisted with management, coordination, and mentoring of graduate students; research and publishing
  %\item \textsc{Lidar}-based strategy for non-cooperative rendezvous for satellite servicing and asteroid rendezvous
  \item Wrote and released open source Open\textsc{gl} sensor simulator, spacecraft simulation
...
\begin{itemize*}
  ...
  \item Artificial life simulation (\textsc{hiv} evolution)
  \item Scheme and partial implementation re-engineering cellular metabolism in \textit{E.~coli} to produce key chemicals
\end{itemize*}
...
\begin{itemize*}
  \item Multilingual noun phrase identification for abstract concept map generation, machine translation; part of speech tagging, hidden Markov models, large text corpora
\end{itemize*}
...
\begin{itemize*}
  \item Mental health first aid, holding space, conflict mediation; training of other green dots
\end{itemize*}
%
%\medskip
...
\begin{itemize*}
  \item Wrote Ruby linear algebra library, NMatrix; mentored Google Summer of Code students and organized mentors
\end{itemize*}
...
\begin{itemize*}
  ...
  \item Evidence-based public safety policy analyses aimed toward the Texas Legislature
  \item Organizing of key stakeholders to produce policy change
\end{itemize*}
...
%\bigskip
%\mhead{Other Skills}%
%Metal fabrication and \textsc{mig} welding, fiberglass/resin casting, \textsc{fema} Incident Command System (\textsc{ics}-100) certification, telehandler certification, forklift certification
...
%\medskip
%Edward~Marcotte\rdate{\href{mailto:marcotte@icmb.utexas.edu}{marcotte@icmb.utexas.edu}}\newline
%Professor of Chemistry \& Biochemistry, The University of Texas at Austin

%\medskip
%Andrew Ellington\rdate{\href{mailto:ellingtonlab@gmail.com}{ellingtonlab@gmail.com}}\newline
%Professor of Molecular Biosciences, The University of Texas at Austin
\end{document}