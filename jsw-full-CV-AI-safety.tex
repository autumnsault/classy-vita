...
\centering\small applied math \hskip 3mm$\circ$ \hskip 3mm public policy \hskip 3mm$\circ$ \hskip 3mm evolutionary systems biology \hskip 3mm$\circ$ \hskip 3mm aerospace engineering
\vskip-6pt
\hrulefill
\end{adjustwidth}  
\reversemarginpar 
...
\begin{itemize*}
    \item Designed, implemented, and hardware tested custom process automation framework (finite state automata and various \textsc{pid} controllers) for use in carbon sequestration
...
\begin{itemize*}
   \item Derived, designed, and prototyped navigation system and wrote simulation models for \textsc{xl}-1 lunar lander
...
\begin{itemize*}
  ...
  \item Designs and analyses: navigation, orbit determination, sensors, trajectory
...
\begin{itemize*}
  \item Worked on simulation, mission design, \textsc{gn\&c}, and trajectory optimization during design phase across two lunar landers and a commercial space station (Moon Express \textsc{mx}-1 and \textsc{nova-c}, Axiom)
...
\begin{itemize*}
  \item Multilingual noun phrase identification for abstract concept map generation, machine translation
  \item Part of speech tagging, hidden Markov models, large text corpora
\end{itemize*}
...
\textbf{Take 3 Presents}\rdate{2022--\textsc{present}}\newline
\emph{Greeters Lead} \rdate{2021--2022}
\begin{itemize*}
...
\emph{Green Dot Trainer} \rdate{\textsc{June}~2023--\textsc{present}}
\begin{itemize*}
  \item Mental health first aid, holding space
  \item Conflict mediation
  \item Training of other green dots
\end{itemize*}
