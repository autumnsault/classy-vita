...
\centering\large computer scientist\hskip 3mm$\circ$\hskip 3mm\textsc{gn\&c} specialist\hskip 3mm$\circ$\hskip 3mmevolutionary systems biologist
\vskip-6pt
\hrulefill
\end{adjustwidth}  
\reversemarginpar 
...
\emph{Post-doctoral Fellow --- Aerospace Engineer} \rdate{\textsc{jan}~2014--\textsc{present}}
\begin{itemize*}
  \item On contract with \textsc{Nasa gsfc}'s Satellite Servicing Capabilities Office
  \item Working on \textsc{lidar}-based relnav tools for non-cooperative rendezvous
  \item Developed fast, accurate \textsc{6\,dof} pose initialization strategy
  \item Developed open source Open\textsc{gl}-based \textsc{3d} sensor simulator
  ...
  \item Wrote orbital physics simulator for end-to-end rendezvous simulation and testing
  \item Studying remote sensing technologies for space natural resource surveying and utilization
  \item Collaborating with and mentoring grad students and an undergraduate
\end{itemize*}
...
\begin{itemize*}
  ...
  \item Wrote three successful Google Summer of Code applications and directed mentors two years in a row
\end{itemize*}
...
\begin{itemize*}
  ...
  \item Counseled board on non-profit law and best practices
...
\bigskip
\mhead{Articles}%
\par\vspace{-\baselineskip}\textbf{Woods, J.O.}; Rhodes, A.; Sell, J.L.; Christian, J.A. 2015. \textsc{Lidar}-based relative navigation with respect to non-cooperative objects. \textbf{In preparation.}
...
\medskip
\par\textbf{Woods, J.O.}; Christian, J.A. March 2015. \textsc{Glidar}: An Open\textsc{gl}-based, real-time, and open source \textsc{3d} sensor simulator for testing machine vision algorithms. \textit{International Journal of Computer Vision}, \textbf{submitted.} 
...
\medskip
Sell, J.L.; Rhodes, A.; \textbf{Woods, J.O.}; Christian, J.A.; Evans, T. 2014. In \textit{AIAA/AAS Astrodynamics Specialist Conference}.
...
\bigskip
\mhead{Invited Talks}%
\par\vspace{-\baselineskip}SXSWedu session: Keeping Schools Secure. 11 March 2015.
