...
%\end{itemize*}
\emph{Director of Engineering Research \& Strategy} \rdate{\textsc{jul}~2020--\textsc{present}} \\
...
\begin{itemize*}
  ...
  \item Researched multilateral arms control treaties, U.S. export control policy, and policy limitations on international collaboration toward peaceful space exploration and settlement
\end{itemize*}
