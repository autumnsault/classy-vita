...
\begin{itemize*}
  \item Responsible for development and maintenance of navigation filter for \textsc{im}'s universal flight software, to be flown on a deorbiter (\textsc{im}'s Terrestrial Return Vehicle, or \textsc{trv}), Moon Express' moon lander, and two drones
  ...
  \item Developed a relative navigation model (a batch processor) for an acoustic ranging-based underground navigation system for a drilling project
\end{itemize*}
...
\begin{itemize*}
  \item Making 1,100 plaster masks to take to Black Rock City in 2016 for visitors to paint under the man
\end{itemize*}
...
\bigskip
\mhead{Articles}%
\par\vspace{-\baselineskip}\textbf{Woods, J.O.}; Rhodes, A.; Sell, J.L.; Christian, J.A. 2016. \textsc{Lidar}-based relative navigation with respect to non-cooperative objects. \textit{Acta Astronautica}, \textbf{revisions submitted.}

\medskip
\par\textbf{Woods, J.O.}; Christian, J.A. 2016. \textsc{Glidar}: An OpenGL-based, real-time, and open source 3\textsc{d} sensor simulator for testing computer vision algorithms. \textit{Journal of Imaging}, \textbf{revisions submitted.}
