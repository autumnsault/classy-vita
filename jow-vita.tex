...
\centering\small navigation \& state estimation \hskip 3mm$\circ$\hskip 3mm mission design \& analysis \hskip 3mm$\circ$\hskip 3mm systems engineering \hskip 3mm$\circ$\hskip 3mm guidance%evolutionary systems biology
\vskip-6pt
\hrulefill
\end{adjustwidth}  
\reversemarginpar 
...
\emph{\textsc{gn\&c} engineer, 6-\textsc{dof} (contractor)} \rdate{\textsc{jul}~2021--\textsc{present}}
\begin{itemize*}
...
\begin{itemize*}
  \item Algorithms and data structures in Python, Perl, Ruby, and \textsc{c}/\Cpp; pipelines and automation for large datasets
  \item Synthetic biology, \textsc{hiv} evolution, and evolutionary systems biology%, by quickly predicting gene--disease and gene--phenotype associations
...
\vskip -1em
\textbf{Lunar Surface Innovation Consortium}\rdate{2018--\textsc{present}}\newline
...
\medskip
\emph{Familiar}\ 
Java, \textsc{sql}, shell scripting, Agile, Julia, \textsc{vhdl} 
