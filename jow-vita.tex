...
\centering\small guidance, navigation, \& control \hskip 3mm$\circ$\hskip 3mm statistics \& applied mathematics \hskip 3mm$\circ$\hskip 3mm empathy\hskip 3mm$\circ$\hskip 3mm design %evolutionary systems biology
%\centering\small evolutionary systems biology \hskip 3mm$\circ$\hskip 3mm statistics \& applied mathematics \hskip 3mm$\circ$\hskip 3mm empathy\hskip 3mm$\circ$\hskip 3mm design %evolutionary 
\vskip-6pt
\hrulefill
\end{adjustwidth}  
\reversemarginpar 
...
\bigskip
\mhead{Other Skills}%
Metal fabrication and \textsc{mig} welding, fiberglass/resin casting, \textsc{fema~ics}-100 certification, \textsc{osha} forklift certification
\bigskip
...
\begin{itemize*}
   ...
   \item Created simulation Monte Carlo configuration framework, wrote system and sensor models
...
\emph{Co-creator} \rdate{\textsc{may}~2021--\textsc{sep}~2022}
\begin{itemize*}
   \item Conceived of project idea and worked on a team of $\sim$30 volunteers to produce an art project with a materials budget of $\sim$\$40\textsc{k}; wrote sound design engineering requirements and schedule; chaired fundraising team
%   \item Assisted in coordinating activities of teams (fire, sound, lighting, interactivity, fabrication) to fulfill artistic vision
%   \item Installed and ran project at Burning Man 2022
\end{itemize*}
%
\medskip
