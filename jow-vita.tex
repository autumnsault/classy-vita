...
%
{
  ...
  \begin{minipage}[b]{2.5in}
    ...
    linkedin:\href{https://www.linkedin.com/in/junowoods}{junowoods}
  \end{minipage}
}\par
\hrulefill
...
%\end{itemize*}
\emph{Senior Researcher} \rdate{\textsc{mar}~2021--\textsc{present}} \\
\emph{Director of Engineering Research \& Strategy} \rdate{\textsc{jul}~2020--\textsc{mar}~2021} \\
\emph{Contractor, Research \& Strategy} \rdate{\textsc{apr}~2020--\textsc{jul}~2020} \\
\emph{Guidance, Navigation, \& Control} \rdate{\textsc{oct}~2019--\textsc{apr}~2020}
\begin{itemize*}
  \item Produced designs and analyses for open source spacecraft (cubesat, lunar orbiter, and lunar lander); developed open source tools for sensor trades (linear covariance analysis, extended Kalman filter prototype, orbit determination prototype, patched conic trajectory optimizer); derived radiometric measurement models; supervised graduate student working trajectory design (\textsc{cr3bp} trajectory optimizer)
  \item Studied positioning, navigation, and timing architectures; crater navigation; export control policy; and open source in the space industry. %Submitted export control advisory opinion request to DDTC.
  \item Designed business models around optical navigation hardware and interplanetary radios; led \textsc{sbir} Phase I proposal for X/Ka-band LunaNet radio architecture
  \item Researched multilateral arms control treaties, U.S. export control policy, electronic frontiers, and policy limitations on international collaboration toward peaceful space exploration and settlement; currently writing research articles on these topics
\end{itemize*}
...
\medskip
\par\textbf{Woods, J.O.} 2020. Concepts in lunar positioning, navigation, and timing. \textit{OLF--GNC--2020--01}, Open Lunar Foundation, San Francisco, CA. \textit{Work in progress.}
...
\medskip
\emph{Familiar}\ 
\textsc{vhdl}, Java, \textsc{sql}, shell scripting, Agile development methodology

\medskip
\emph{Forgotten}\
Perl, Fortran~95, regular expressions
